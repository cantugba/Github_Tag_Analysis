...
if __name__ == '__main__':
    ...
    # # Ekim Ayı
    # filename1 = 'Datas/OctoberDatas/data3.json'
    # filename2 = 'Datas/OctoberDatas/data4.json'

    # # Kasım Ayı
    # filename1 = 'Datas/NovemberDatas/data3.json'
    # filename2 = 'Datas/NovemberDatas/data4.json'

    # Aralık Ayı
    filename1 = 'Datas/DecemberDatas/data3.json'
    filename2 = 'Datas/DecemberDatas/data4.json'
