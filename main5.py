...
if __name__ == '__main__':
    ...
    # # Ekim Ayı
    # filename1 = 'Datas/OctoberDatas/data9.json'
    # filename2 = 'Datas/OctoberDatas/data10.json'

    # # Kasım Ayı
    # filename1 = 'Datas/NovemberDatas/data9.json'
    # filename2 = 'Datas/NovemberDatas/data10.json'

    # Aralık Ayı
    filename1 = 'Datas/DecemberDatas/data9.json'
    filename2 = 'Datas/DecemberDatas/data10.json'
