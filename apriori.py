...
# store_data = pd.read_csv('/Users/tubac/PycharmProjects/GithubData/All_Data.csv')
...
for item in birliktelik_sonuc:
    ...
    print("Lift: " + str(item[2][0][3]))
    print("=====================================")
    #df = pd.DataFrame([[items[0], items[1], str(item[1]), str(item[2][0][2]), str(item[2][0][3])]],
                      #columns=['tag 1', 'tag 2', 'destek', 'guven', 'lift'])
